...
func setup():
	...
	name = "g_haveconversation" # String to identify the goal from others after creation
	priority = 8.0 # The higher this number, the more important the goal. Agent will always want to fulfill the goal with the highest priority first
	...
	add_symbol('s_havingconversation', true)
	return
...
func evaluate():
	...
	if entity.check_having_conversation():
		return {'s_havingconversation': false}
