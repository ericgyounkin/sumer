...
func setup():
	...
	name = 'a_flee'               # String identifier of this action.  setup_common() will make sure the action's node is named after this
...
func get_target_location():
	...
	if entity.is_network_master():
		...
		entity.mousepos = entity.flee_direction
		entity.rset('slave_mousepos', entity.mousepos)
		if global.netdebug:
			print('rset slave_mousepos')
