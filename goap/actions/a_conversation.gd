...
func setup():
	...
	name = 'a_conversation'               # String identifier of this action.  setup_common() will make sure the action's node is named after this
	...
	add_effect('s_havingconversation', true)
	return
...
func execute():
	...
	if entity.fleeing:
		return ABORTED
	elif !entity.check_having_conversation():
		return COMPLETED
