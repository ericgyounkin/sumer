...
func setup():
	...
	name = 'a_wander'               # String identifier of this action.  setup_common() will make sure the action's node is named after this
...
func get_target_location():
	...
	if entity.is_network_master():
		var wander_offset = Vector2(rand_range(-800,800), rand_range(-800,800))
